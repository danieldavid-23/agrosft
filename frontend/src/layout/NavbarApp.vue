      ...
      <div class="collapse navbar-collapse" :class="{ show: showMobileMenu }" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-center">
          <template v-if="is_authenticated && user">
              <template v-if="user.is_staff || user.is_superuser">
                <li class="nav-item">
                  <a class="nav-link" :class="{ active: isActive(urls.admin_usuarios) }" :href="urls.admin_usuarios"><i class="fas fa-users-cog me-1 d-lg-none"></i> Usuarios</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" :class="{ active: isActive(urls.admin_categorias) }" :href="urls.admin_categorias"><i class="fas fa-tags me-1 d-lg-none"></i> Categorías</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" :class="{ active: isActive(urls.admin_moderacion) }" :href="urls.admin_moderacion"><i class="fas fa-gavel me-1 d-lg-none"></i> Moderación</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" :class="{ active: isActive(urls.admin_estadisticas) }" :href="urls.admin_estadisticas"><i class="fas fa-chart-pie me-1 d-lg-none"></i> Estadísticas</a>
                </li>
              </template>
              <template v-else>
                <li class="nav-item">
